    ...
    <>
      ...
      <div>
            ...
            <div className="grid grid-cols-1 grid-rows-3 gap-8 py-12">
              ...
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  ...
                  <Link href="https://medium.com/@lifeofpavan">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span className="pr-6 text-gray-900 dark:text-gray-100">My project stories on Medium</span>
                      </span>
              ...
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  <div className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r  from-pink-600 to-purple-600 opacity-50 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>
                  <Link href="https://drive.google.com/file/d/1fDQ6-o85nlZWHVoWNymbVA2zs5DQL0VQ/view?usp=drive_link">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
        ...
        <h2 className="flex pb-6 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100 sm:text-3xl md:text-5xl">
          Explore my coursework and certifications
        </h2>
